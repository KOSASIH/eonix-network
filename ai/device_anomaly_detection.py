...
if __name__ == "__main__":
    device_anomaly_detection = DeviceAnomalyDetection("eonix_network_data.csv")
    device_anomaly_detection.train_model()
    input_data = [[1, 2, 3, 4, 5]]
    anomalies = device_anomaly_detection.detect_anomalies(input_data)
    print(anomalies)
